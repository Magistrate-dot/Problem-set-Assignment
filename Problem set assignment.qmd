...
#hearder Problem set question 1 : You are given two objects that are meant to be merged and then plotted, but the join key is misspelled and the plot is using the wrong column.
...
below is the code that answer to the question.
...
#header Problem set question 2: Wide to long and grouped summaries
...
#header Problem set question 3 : Controlled randomness and NA handling
...
The answers to the questions is bellow.
...
#header Problem set question 4 : Writing a small, flexible summary function
